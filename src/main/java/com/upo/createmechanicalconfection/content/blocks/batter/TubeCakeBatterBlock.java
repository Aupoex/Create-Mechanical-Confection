...
public class TubeCakeBatterBlock extends BaseCakeBatterBlock{

    public TubeCakeBatterBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldStack, BlockState state, Level level, BlockPos pos,
        ...
        if (heldStack.is(Items.BAKED_POTATO)) {
            Block filledBlock = CMCBlocks.FILLED_TUBE_CAKE_BATTER_BLOCK.get();
