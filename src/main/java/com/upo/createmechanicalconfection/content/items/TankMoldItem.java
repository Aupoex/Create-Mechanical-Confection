...
public class TankMoldItem extends Item {

    public TankMoldItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (clickedState.is(CMCBlocks.RAW_CAKE_BATTER_BLOCK.get())) {
            if (!level.isClientSide) {
                level.setBlock(pos, CMCBlocks.TANK_CAKE_BATTER_BLOCK.get().defaultBlockState(), 3);
